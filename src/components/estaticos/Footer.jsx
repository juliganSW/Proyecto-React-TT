    ...
    <footer>
      <div className="footer-container">
        <div className="arriba-izq">
          <p>Seguinos</p>
          <ul>
            <li><Link to="https://www.facebook.com/" target="_blank"><i className="fa-brands fa-facebook fa-2xl"></i></Link></li>
            <li><Link to="https://www.instagram.com/" target="_blank"><i className="fa-brands fa-instagram fa-2xl"></i></Link></li>
            <li><Link to="https://www.x.com/" target="_blank"><i className="fa-brands fa-x-twitter fa-2xl"></i></Link></li>
            <li><Link to="https://www.pinterest.com/" target="_blank"><i className="fa-brands fa-pinterest fa-2xl"></i></Link></li>
          </ul>
        </div>
        ...
        <div>
          <Link to="https://www.whatsapp.com/" target="_blank"><i className="fa-brands fa-whatsapp"></i></Link>
        </div>
        <div className="abajo">
          <div>
            {/* <Link><i className="fa-solid fa-circle-up back_to_top"></i></Link> */}
          </div>
