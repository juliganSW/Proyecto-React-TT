  ...
  return (
    <div className={`cart-drawer ${isOpen ? 'open' : ''}`}>
      <div className='cart-header'>
        ...
        <button className="cartCloseBtn"aria-label='Cerrar carrito' onClick={onClose}>X</button>
      </div>
          ...
          cart.length === 0 ? (
            ...
            <>
              ...
              <div style={{ textAlign: 'center', marginTop: '0.5rem' }}>
                <button aria-label='Limpiar carrito' onClick={clearCart} style={{ backgroundColor: '#39f2ae', color: '#000', padding: '8px 12px', borderRadius: '6px' }}>
                  Finalizar
                </button>
              </div>
            </>
